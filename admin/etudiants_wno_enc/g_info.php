...
<html lang="fr" dir="ltr">
  <head>
    ...
    <title>Les étudiants sans encadrant (Génie Informatique)</title>
...
<body>
  ...
  <h4 align="center">La liste des étudiants sans encadrant (Génie Informatique)</h4>
  <div class="row">
    <div class="col-md-12">
        <!-- Advanced Tables -->
        <div class="card">
            <div class="card-content">
                <div class="table-responsive">
                    <table class="table table-striped table-bordered table-hover" id="dataTables-example">
                        ...
                        <tbody>
                          <?php 
                            $sql = "SELECT * from etudiant where ISNULL(id_encadrant)=1 and filiere = 'NDIGEIN' and visite=1 order by nom";
