...
<html lang="fr" dir="ltr">
  <head>
    ...
    <title>La liste des étudiants sans encadrant (Génie Mécatronique)</title>
...
<body>
    ...
    <ul class="nav-links">
      ...
      <li>
        ...
        <ul class="sub-menu">
          ...
          <li><a href="#">G.Mécatronique</a></li>
          <li><a href="./g_elec.php">G.Électrique</a></li>
  ...
  <h4 align="center">La liste des étudiants sans encadrant (Génie Mécatronique)</h4>
  <div class="row">
    <div class="col-md-12">
        <!-- Advanced Tables -->
        <div class="card">
            <div class="card-content">
                <div class="table-responsive">
                    <table class="table table-striped table-bordered table-hover" id="dataTables-example">
                        ...
                        <tbody>
                          <?php 
                            $sql = "SELECT * from etudiant where ISNULL(id_encadrant)=1 and filiere = 'NDIGEME' and visite=1 order by nom";
