...
<body>
  ...
  <h4 align="center">Affichage des notes</h4>
  <div class="row">
    <div class="col-md-12">
        <!-- Advanced Tables -->
        <div class="card">
            <div class="card-content">
                ...
                <form action="" method="post">
                    <table class="table table-striped table-bordered table-hover" id="dataTables-example">
                        ...
                        <tbody>
                          <?php 
                            $sql = "SELECT * from etudiant inner join enseignant on etudiant.id_encadrant=enseignant.id_encadrant where note > 0 order by etudiant.nom";
                            ...
                            while ($data=mysqli_fetch_assoc($result)) { 
                              ...
                              if ($count%2 == 0) { ?>
                                <tr class="even gradeX">
                                  ...
                                  <td class="center"><?php echo $data['note']; ?></td>
                                </tr>
                        <?php }else { ?>
                          <tr class="even gradeX">
                                  <td class="center"><?php echo $data['num_appogee']; ?></td>
            ...
            <button class="btn btn-primary"><a style="color: white" href="./excel_download.php">Download Excel file</a></button>
        </div>
    </div>
  </div>
  <div>
